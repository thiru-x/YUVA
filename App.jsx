...
const MEMORIES = [
  { id: 1, url: '/memories/Family Pic.jpeg', caption: "Cherished Family Moments" },
  { id: 1, url: '/memories/DSLR.JPG', caption: "Getting Distant" },
  { id: 2, url: '/memories/Home.jpeg', caption: "Home Sweet Home" },
  { id: 3, url: '/memories/Kutty.jpeg', caption: "The Little One" },
  { id: 4, url: '/memories/kutty2.jpg', caption: "Growing Up" },
  { id: 5, url: '/memories/Srirangam.jpeg', caption: "Spiritual Peace at Srirangam" },
  { id: 6, url: '/memories/Srirangam 2.jpeg', caption: "Exploring Ancient Beauty" },
  { id: 7, url: '/memories/Srirangam 3.jpeg', caption: "Sacred Memories" },
  { id: 8, url: '/memories/anna.png', caption: "Sibling Fun time" },
  { id: 9, url: '/memories/cry.png', caption: "Those Emotional Moments" },
  { id: 10, url: '/memories/ear.png', caption: "Silly Faces & Fun" },
  { id: 11, url: '/memories/family.png', caption: "Always Together" },
  { id: 12, url: '/memories/function.png', caption: "Special Family Functions" },
  { id: 13, url: '/memories/Srijeevi.jpg', caption: "SriJeevi Days" },
  { id: 14, url: '/memories/scho.png', caption: "Golden School Memories" },
  { id: 15, url: '/memories/school2.png', caption: "Old School Days" },
  { id: 16, url: '/memories/SEarpunch.png', caption: "Childhood Punch" },
  { id: 17, url: '/memories/SEarpunch.mp4', caption: "Fun of AI" },
  { id: 18, url: '/memories/Buterfly.jpg', caption: "A Beautiful Moment" },
  { id: 19, url: '/memories/ReDress.jpg', caption: "Looking Stunning" },
  { id: 20, url: '/memories/dharmasthalam.jpg', caption: "Peaceful Dharmasthalam" },
];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-pink-500 selection:text-white">
      ...
      {stage === 'vault' && (
        <div className="animate-in fade-in zoom-in duration-1000 pb-20">
            ...
            <section className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-slate-900/50 border border-slate-800 rounded-3xl hover:bg-slate-900 transition-colors group">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  You’ve always been the one to light up the way. ng my firsThanks for guiding me through life (and debuggit codes).
                </p>
              </div>
              <div className="p-8 bg-slate-900/50 border border-slate-800 rounded-3xl hover:bg-slate-900 transition-colors group">
          ...
          {selectedImg && (
            <div className="fixed inset-0 z-[100] bg-black/95 flex items-center justify-center p-4 md:p-12 animate-in fade-in duration-300">
              ...
              <div className="max-w-4xl w-full flex flex-col md:flex-row gap-8 items-center">
                {selectedImg.url.toLowerCase().endsWith('.mp4') ? (
                  <video
                    src={selectedImg.url}
          ...
          <footer className="text-center py-20 text-slate-500 text-sm">
            <p>© 2026 Developed with ❤️ by your CSE Brother</p>
          </footer>
        </div>
      )}
      ...
      {isPlaying && (
        <div className="fixed bottom-6 right-6 z-[60] flex items-center space-x-2 bg-slate-900/90 border border-slate-800 px-4 py-2 rounded-full backdrop-blur-sm animate-bounce">
          ...
          <span className="text-xs font-medium text-pink-400">Aazhi-Soozhndha.mp3</span>
        </div>
      )}

      {/* Background Audio */}
      <audio ref={audioRef} src="/memories/Aazhi-Soozhndha.mp3" loop />
    </div>
  );
};
